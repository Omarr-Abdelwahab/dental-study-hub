import { c as formatClock, i as courseLessons, l as formatDate, p as isAccessActive, r as useStore, s as daysRemaining, u as formatDateTime } from "./store-By_ZMgNx.js";
import { t as AppHeader, u as Button } from "./app-shell-CAxw0SYi.js";
import { t as Badge } from "./badge-DDEClDpn.js";
import { t as Progress } from "./progress-CuwXnkvg.js";
import { a as courseProgressPercent, d as isEnrolled, g as studentAnnouncements, h as streakInfo, p as lastWatched, r as completedLessons, s as findLesson } from "./selectors-Z06sDMBN.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Bell, BookOpen, Bookmark, CalendarClock, CheckCircle2, Flame, GraduationCap, History, LockKeyhole, Play, Trophy } from "lucide-react";
//#region src/routes/dashboard.tsx?tsr-split=component
function StudentDashboard() {
	const { state, user, enterDemo } = useStore();
	if (!user || user.role !== "student") return /* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(GraduationCap, { className: "size-6" })
					}),
					/* @__PURE__ */ jsx("h1", {
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						className: "mt-7 h-11",
						children: ["Enter Student Demo ", /* @__PURE__ */ jsx(ArrowRight, {})]
					})
				]
			})
		})]
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AppHeader, {}), /* @__PURE__ */ jsxs("main", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						...
						children: /* @__PURE__ */ jsxs(Link, {
							to: "/courses",
							children: ["Browse more courses ", /* @__PURE__ */ jsx(ArrowRight, {})]
						})
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					className: "mt-8 grid gap-5 xl:grid-cols-[1.55fr_.75fr]",
					children: [continueCourse && continueLesson ? /* @__PURE__ */ jsxs("section", {
						className: "relative overflow-hidden rounded-3xl bg-navy p-6 text-white shadow-lift sm:p-8",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-24 -top-24 size-64 rounded-full bg-primary/20 blur-3xl" }), /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("span", {
										...
										children: [
											/* @__PURE__ */ jsx(History, { className: "size-3.5 text-primary" }),
											"Resume at ",
										...
										className: "inline-flex items-center gap-1.5",
										children: [
											/* @__PURE__ */ jsx(CalendarClock, { className: "size-3.5 text-primary" }),
								...
								/* @__PURE__ */ jsx(Button, {
									...
									children: /* @__PURE__ */ jsxs(Link, {
										...
										children: [/* @__PURE__ */ jsx(Play, {}), " Continue lesson"]
									})
								})
							] }), /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("img", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										}), /* @__PURE__ */ jsxs("span", { children: [courseProgressPercent(state, user.id, continueCourse), "%"] })]
									}), /* @__PURE__ */ jsx("div", {
						...
						children: [
							/* @__PURE__ */ jsx(BookOpen, { className: "size-9 text-primary" }),
							/* @__PURE__ */ jsx("h2", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
									...
									children: [
										/* @__PURE__ */ jsx(Flame, { className: "size-7 fill-orange-500 text-orange-500" }),
										" ",
										streak.current,
										" days"
									]
									...
									children: /* @__PURE__ */ jsx(Trophy, { className: "size-5" })
								})]
							}),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: streak.week.map((day) => /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: day.active ? /* @__PURE__ */ jsx(Flame, { className: "size-3.5 fill-current" }) : /* @__PURE__ */ jsx("span", { className: "size-1.5 rounded-full bg-current opacity-25" })
									})]
								}, day.key))
							}),
							/* @__PURE__ */ jsxs("p", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("img", {
										...
										children: [
											...
											nextLesson && /* @__PURE__ */ jsx(Button, {
												size: "sm",
												className: "mt-5",
												asChild: true,
												children: /* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
								...
								children: "Bookmarks"
							})] }), /* @__PURE__ */ jsx(Bookmark, { className: "size-5 text-primary" })]
						}), /* @__PURE__ */ jsx("div", {
							className: "mt-4 divide-y",
							children: bookmarks.length ? bookmarks.map(({ course, lesson }) => /* @__PURE__ */ jsxs(Link, {
								to: "/learn/$courseId/$lessonId",
								params: {
									courseId: course.id,
									lessonId: lesson.id
								...
								}), /* @__PURE__ */ jsx(ArrowRight, { className: "size-4 shrink-0 text-muted-foreground group-hover:text-primary" })]
							}, lesson.id)) : /* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							className: "mt-4 divide-y",
							children: announcements.slice(0, 3).map((announcement) => /* @__PURE__ */ jsxs("article", {
								className: "py-4",
								children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							...
							children: expiredCourses.map((course) => /* @__PURE__ */ jsxs("article", {
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("p", {
												className: "truncate font-bold text-navy",
												children: course.title
											}), /* @__PURE__ */ jsx(LockKeyhole, { className: "size-4 shrink-0 text-muted-foreground" })]
										}),
										/* @__PURE__ */ jsxs("p", {
											className: "mt-1 text-xs text-muted-foreground",
